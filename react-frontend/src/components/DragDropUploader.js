...
function DragDropUploader({ onFilesAdded }) {
  ...
  const onDrop = (evt) => {
    evt.preventDefault();
    if (onFilesAdded) {
      onFilesAdded(evt.dataTransfer.files);
    }
    setHighlight(false);
  };
  ...
  return (
    <div className="flex items-center justify-center w-full">
      <label
        ...
        bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 
